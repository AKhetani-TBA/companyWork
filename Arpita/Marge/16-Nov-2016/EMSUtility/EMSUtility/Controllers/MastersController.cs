...
namespace EMSUtility.Controllers
{
    public class MastersController : Controller
    {
        ...
        [HttpGet]
        public JsonResult GetRoles(int activeId = 0)
        {
            if (Session["EmpBasicDetails"] != null)
            {
                var jsonData = new
                {
                    data = from emp in mastersBLL.GetRoleDetails(0,activeId).ToList() select emp
                };
        ...
        public ActionResult AddRoleDetails(Role roleDetails)
        {
            ...
            roleDetails.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateRoleDetails(Role roleDetails)
        {
            ...
            roleDetails.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
        ...
        public ActionResult RoleAllocations()
        {
            if (Session["EmpBasicDetails"] != null)
            {
                ...
                ViewBag.RoleNames = new SelectList(lstRole.OrderBy(x => x.RoleName), "RoleId", "RoleName");
                return View();
            }
            else
            {
        ...
        [HttpGet]
        public JsonResult GetRoleAllocationDetails(int activeId = 0)
        {
            if (Session["EmpBasicDetails"] != null)
            {
                var jsonData = new
                {
                    data = from emp in mastersBLL.GetRoleAllocationDetails(0,activeId).ToList() select emp
                };
                return Json(jsonData, JsonRequestBehavior.AllowGet);
            }
            else
        ...
        public ActionResult AddRoleAllocation(RoleAllocation roleAllocation)
        {
            ...
            roleAllocation.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateRoleAllocation(RoleAllocation roleAllocation)
        {
            ...
            roleAllocation.ModifyBy = WindowsIdentity.GetCurrent().Name;
            roleAllocation.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
        ...
        [HttpGet]
        public JsonResult GetDepartment(int activeId)
        {
            if (Session["EmpBasicDetails"] != null)
            {
                var jsonData = new
        ...
        public ActionResult AddDepartmentDetails(Department departmentDetails)
        {
            ...
            departmentDetails.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateDepartmentDetails(Department departmentDetails)
        {
            ...
            departmentDetails.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy"); 
        ...
        public ActionResult AddDepartmentAllocation(DepartmentAllocation departmentAllocation)
        {
            ...
            departmentAllocation.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateDepartmentAllocation(DepartmentAllocation departmentAllocation)
        {
            ...
            departmentAllocation.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
        ...
        [HttpGet]
        public JsonResult GetDesignation(int activeId = 0)
        {
            if (Session["EmpBasicDetails"] != null)
            {
                var jsonData = new
                {
                    data = from emp in mastersBLL.GetDesignationDetails(0,activeId).ToList() select emp
                };
                return Json(jsonData, JsonRequestBehavior.AllowGet);
            }
            else
        ...
        public ActionResult AddDesignationDetails(Designation designationDetails)
        {
            ...
            designationDetails.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateDesignationDetails(Designation designationDetails)
        {
            ...
            designationDetails.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
        ...
        public ActionResult AddDesignationAllocationDetails(DesignationAllocation designationAllocation)
        {
            ...
            designationAllocation.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        [HttpGet]
        public JsonResult GetDesignationAllocation(int activeId = 0)
        {
            if (Session["EmpBasicDetails"] != null)
            {
                var jsonData = new
                {
                    data = from emp in mastersBLL.GetDesignationAllocation(0,activeId).ToList() select emp
                };
                return Json(jsonData, JsonRequestBehavior.AllowGet);
            }
            else
        ...
        public ActionResult UpdateDesignationAllocation(DesignationAllocation designationAllocation)
        {
            ...
            designationAllocation.ModifyBy = WindowsIdentity.GetCurrent().Name;
            designationAllocation.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
        ...
        public ActionResult AddTechnology(Technology technology)
        {
            ...
            technology.CreatedDate = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        public ActionResult UpdateTechnology(Technology technology)
        {
            ...
            technology.ModifyDate = DateTime.Now.ToString("dd/MM/yyyy");  
