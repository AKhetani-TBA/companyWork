        ...
        public static void AlertMessage(int MessageID, string Message)
        {
            switch (MessageID)
            {
                ...
                case 24:
                    ...
                    break;
                case 25:
                    MessageBox.Show("Only 500 cusips supported at a time in Top of the Book.", "Cusip Max Limit Reached", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                    break;
                case 26:
                    MessageBox.Show("Only 100 cusips supported at a time in Depth of the Book.", "Cusip Max Limit Reached", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                    break;
                case 27:
