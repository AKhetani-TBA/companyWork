        ...
        public static void AlertMessage(int MessageID, string Message)
        {
            switch (MessageID)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    MessageBox.Show("New Password & Confirm password does not match.", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                case 5:
                ...
                case 22:
                    ...
                    break;
                case 23:
                    MessageBox.Show("Please enter valid email.", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                case 24:
                    MessageBox.Show("Could not connect to server. You have to relogin to continue.", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                case 25:
                    MessageBox.Show(Message+ " Addin must need to upgrade to newer version. Please relogin to allow program to upgrade.", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                case 26:
                    MessageBox.Show(Message + "Loading addin failed. Please enable addin manually.", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                default:
                    break;
            }
