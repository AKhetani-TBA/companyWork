...
namespace Trader.Events
{
    public static class BeastEventAggregatorExtensions
    {
        private static IBeastEventAggregatorExtensionsProvider _provider = new PrismEventAggregatorExtensionsProvider();

        public static void SetProvider(IBeastEventAggregatorExtensionsProvider provider)
        {
            _provider = provider;
        }
        ...
        public static SubscriptionToken Subscribe<TEvent>(this IEventAggregator eventAggregator,
                                                          Action<TEvent> subscription, bool keepSubscriberReferenceAlive)
        {
            return _provider.Subscribe<TEvent>(eventAggregator, subscription, keepSubscriberReferenceAlive);
        }

        public static SubscriptionToken Subscribe<TEvent>(this IEventAggregator eventAggregator,
                                                          Action<TEvent> subscription, ThreadOption threadOption,
