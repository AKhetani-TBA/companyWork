...
namespace Beast_Barclay_Addin
{
    ...
    ///     Bonds Peo Class.
    /// </summary>
    internal class BarclayUtility
    {

        #region declared class constructor

        public BarclayUtility()
        {
        ...
        public void SendImageRequest()
        {
            ...
            _utils.StoreBondGridCellName("vcm_calc_barclay_Excel", Globals.ThisAddIn.Application.ActiveWorkbook.Name,
                _barclaySheet.Name, StartRow, StartRowIndexofCusip - 1);
            ...
            _utils.LogInfo("BarclayUtility.cs", "SendImageRequest();", "Send image request - Beast_Barclay_AddIn");
            _utils.SendImageRequest("vcm_calc_barclay_Excel", sifIdOfBarclayExcel, Assembly.GetExecutingAssembly().GetName().Name);
        ...
        public void CloseImageRequest()
        {
            ...
            _utils.LogInfo("BarclayUtility.cs", "CloseImageRequest();", "Close image request - Beast_Barclay_AddIn");
            _utils.CloseImageRequest("vcm_calc_barclay_Excel", sifIdOfBarclayExcel, Assembly.GetExecutingAssembly().GetName().Name);
        }
        ...
        private void InsertNewRealTimeDataSheet()
        {
            try
            {
                ...
                _barclaySheet.Cells[1, 1].ColumnWidth = 16;
                _barclaySheet.get_Range("A1", "F1").EntireColumn.ColumnWidth = 22;
                _barclaySheet.get_Range("A1", "F500").HorizontalAlignment = XlHAlign.xlHAlignLeft;
                var excelRange = _barclaySheet.get_Range("A2", "C2");
                ...
                excelRange = _barclaySheet.get_Range("A4", "B4");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                ...
                excelRange = _barclaySheet.get_Range("A5", "B5");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                excelRange.Value = "Maximum Daily Gross Notional Value:";
                excelRange.Columns.AutoFit();
                excelRange = _barclaySheet.get_Range("C8", "C8");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value =
                ...
                excelRange = _barclaySheet.get_Range("A9", "B9");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                excelRange = _barclaySheet.get_Range("B12", "C12");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                excelRange = _barclaySheet.get_Range("D12", "F12");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                excelRange = _barclaySheet.get_Range("B13", "B13");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value = "Max Order Value";

                excelRange = _barclaySheet.get_Range("C13", "C13");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value = "Max Order Quantity";

                excelRange = _barclaySheet.get_Range("D13", "D13");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value = "Maximum Daily Gross Notional Value";

                excelRange = _barclaySheet.get_Range("E13", "E13");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value = "Maximum Daily Net Long Notional Value";

                excelRange = _barclaySheet.get_Range("F13", "F13");
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Value = "Maximum Daily Net Short Notional Value";

                excelRange = _barclaySheet.get_Range("A14", "C14");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                excelRange = _barclaySheet.get_Range("D14", "F14");
                excelRange.Merge(true);
                excelRange.Font.Name = "Calibri";
                excelRange.Font.Size = "11";
                excelRange.Font.Bold = true;
                ...
                //_barclaySheet.get_Range("H1", "K1").EntireColumn.ColumnWidth = 22;

                //excelRange = _barclaySheet.get_Range("H14", "H14");
                //excelRange.Font.Name = "Calibri";
                //excelRange.Font.Size = "11";
                //excelRange.Value = "TimeStamp";

                //excelRange = _barclaySheet.get_Range("I14", "I14");
                //excelRange.Font.Name = "Calibri";
                //excelRange.Font.Size = "11";
                //excelRange.Value = "UpdatedBy";

                //excelRange = _barclaySheet.get_Range("J14", "J14");
                //excelRange.Font.Name = "Calibri";
                //excelRange.Font.Size = "11";
                //excelRange.Value = "Status";

                //excelRange = _barclaySheet.get_Range("K14", "K14");
                //excelRange.Font.Name = "Calibri";
                //excelRange.Font.Size = "11";
                //excelRange.Value = "Proposed value";
                //_barclaySheet.get_Range("H14", "K14").Borders.LineStyle = XlLineStyle.xlContinuous;
                _barclaySheet.get_Range("B13", "F13").Cells.WrapText = true;
                //    _barclaySheet.Application.ActiveWindow.SplitRow = 13;
                //_barclaySheet.Application.ActiveWindow.FreezePanes = true;

                //_barclaySheet.get_Range("H14", "K14").Interior.Color =
                //    ColorTranslator.ToOle(GetColor(ServerConnectionStatus.HeaderColor));
                //_barclaySheet.get_Range("H14", "K14").Font.Color = ColorTranslator.ToOle(Color.White);
                _barclaySheet.get_Range("A12", "F14").Borders.LineStyle = XlLineStyle.xlContinuous;

                #endregion
            }
            catch (Exception err)
            {
                _utils.ErrorLog("BarclayUtility", "InsertNewRealTimeDataSheet();",
        ...
        private void CallRefresh(string imageName)
        {
            try
            {
                CreateRefreshXml("vcm_calc_barclay_Excel");
            }
            catch (Exception ex)
            {
                _utils.ErrorLog("BarclayUtility.cs", "CallRefresh();", ex.Message, ex);
            }
        }
        ...
        private void btnRefresh_Click(CommandBarButton ctrl, ref bool cancelDefault)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "btnRefresh_Click();", ex.Message, ex);
            }
        }
        ...
        private bool CreateNewRangeForSubmitOrder(Microsoft.Office.Interop.Excel.Range target)
        {
                    ...
                    // Single column of Bid Size/Ask Size from Top of the book
                    {
                        foreach (Microsoft.Office.Interop.Excel.Range cell in target.Cells)
                        {
                            if (cell.Column == 7 || cell.Column == 10)
                            {
                                ...
                                childId.InnerText =
                                    Convert.ToString(_barclaySheet.Cells[cell.Row, StartRowIndexofCusip].Value);
                                ...
                                if (cell.Column == 7)
                                {
                                    ...
                                    childPrice.InnerText =
                                        Convert.ToString(_barclaySheet.Cells[cell.Row, StartRowIndexofCusip + 6].Value);
                                ...
                                else
                                {
                                    ...
                                    childPrice.InnerText =
                                        Convert.ToString(_barclaySheet.Cells[cell.Row, StartRowIndexofCusip + 7].Value);
                        ...
                        foreach (Microsoft.Office.Interop.Excel.Range cell in target.Cells)
                        {
                            if ((tot != cell.Row) && (cell.Column == 29 || cell.Column == 32))
                            {
                                ...
                                if (cell.Column == 29)
                                {
                                    ...
                                    childPrice.InnerText =
                                        Convert.ToString(
                                            _barclaySheet.Cells[cell.Row, StartRowIndexofDepthbook + 6].Value);
                                    //Bid Price from Top of the book
                                }
                                else
                                {
                                    ...
                                    childPrice.InnerText =
                                        Convert.ToString(
                                            _barclaySheet.Cells[cell.Row, StartRowIndexofDepthbook + 7].Value);
                                    //Ask Price from Top of the book
                                }
                                ...
                                while (count != 0)
                                {
                                    if (cell.Row < total)
                                    {
                                        ...
                                        childId.InnerText =
                                            Convert.ToString(
                                                _barclaySheet.Cells[rowno, StartRowIndexofDepthbook].Value);
                                        count = 0;
                                    }
                                    else
                                    {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "CreateNEwRangeForSubmitOrder();", "passing Target Range.", ex);
                return false;
            }
        }
        ...
        public void EnableDisableContextMenu()
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "EnableDisableContextMenu();", "not passing any parameter.", ex);
            }
        }
        ...
        private void DisplayRefreshButton(int targetColumn)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "DisplayRefreshButton();", ex.Message, ex);
            }
        }
        ...
        private void StatusChange(Microsoft.Office.Interop.Excel.Range cellRange)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "statusChange();", ex.Message, ex);
            }
        }
        ...
        public void RightClickDisableMenu(Microsoft.Office.Interop.Excel.Range target)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "RightClickDisableMenu();", "passing Target Range.", ex);
            }
        }
        ...
        public void GetOrderedStatusByOrderId(string actionType, string calcName)
        {
            try
            {
                ...
                _xmlRoot.AppendChild(_xdCusip.CreateElement("Version")).InnerText =
                    Convert.ToString(Resources.EXCEL_BARCLAY_CURRENTVERSION);
                _childCusip = _xmlRoot.AppendChild(_xdCusip.CreateElement("LIMITS"));
        ...
        public void DataGridFill(DataTable dtGrid, string calcName)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "GetOrderedStatusByOrderID();", ex.Message, ex);
            }
        }
        ...
        public void SetCellProperty(string gridId, string eleValue, string htmlClientId)
        {
            try
            {
                if (htmlClientId == "vcm_calc_barclay_Excel" && gridId == "11")
                {
                ...
                if (htmlClientId == "vcm_calc_barclay_Excel" && gridId == "12")
                {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "SetCellProperty();", ex.Message, ex);
            }
        }
        ...
        public void k_keyListener_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "k_keyListener_KeyUp();", ex.Message, ex);
            }
        }
        ...
        internal void ProcessPendingUpdates()
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "ProcessPendingUpdates();", ex.Message, ex);
            }
        }
        ...
        private void UpdateAuditImage(DataRow updateRow, int col, int row, string updatedCalculatorName)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "UpdateAuditImage();", ex.Message, ex);
            }
        }
                ...
                for (var i = 0; i < tableRowCount; i++)
                {
                    ...
                    else
                    {
                        switch (Convert.ToString(updatePackage.UpdateTable.Rows[i]["i"]))
                        {
                            ...
                            case "12":
                                {
                                    SetCellProperty(updatePackage.UpdateTable.Rows[i]["i"].ToString(),
                                        updatePackage.UpdateTable.Rows[i]["d"].ToString(),
                                        updatePackage.UpdatedCalculatorName);
                                    gridNo = Convert.ToString(updatePackage.UpdateTable.Rows[i]["i"]);
                                    break;
                                }
                        }
                    }
                ...
                if (flag)
                {
                    if (updatePackage.UpdatedCalculatorName.ToUpper() == "VCM_CALC_BARCLAY_EXCEL")
                    {
                        ...
                        if (_tobTotalLastRow > _tobTotalCurrentRow)
                        {
                            ...
                            startCell =
                                (Microsoft.Office.Interop.Excel.Range)
                                    _barclaySheet.Cells[StartRow, StartRowIndexofCusip];
                            var endCell =
                                (Microsoft.Office.Interop.Excel.Range)
                                    _barclaySheet.Cells[_tobTotalLastRow + StartRow - 1, EndRowIndexofCusip];
                            // total numbers of Last row count
                            _tobTotalLastRow = _tobTotalCurrentRow;
                            var writeRange = _barclaySheet.Range[startCell, endCell];
                        ...
                        else
                        {
                            ...
                            var endCell =
                                (Microsoft.Office.Interop.Excel.Range)
                                    _barclaySheet.Cells[_tobTotalCurrentRow + StartRow - 1, EndRowIndexofCusip];
                            ...
                            else
                            {
                                startCell =
                                    (Microsoft.Office.Interop.Excel.Range)
                                        _barclaySheet.Cells[StartRow, StartRowIndexofCusip];
                                writeRange = _barclaySheet.Range[startCell, endCell];
                                writeRange.Value = _dataArray1;
                            }
                            MessageFilter.Revoke();
                        }
                        ...
                        {
                            Microsoft.Office.Interop.Excel.Range startAuditCell = (Microsoft.Office.Interop.Excel.Range)_barclaySheet.get_Range("A" + StartRow);
                            Microsoft.Office.Interop.Excel.Range endAuditCell = (Microsoft.Office.Interop.Excel.Range)_barclaySheet.get_Range("A" + StartRow + _tobTotalLastRow);


                            Microsoft.Office.Interop.Excel.Range auditClearRange = _barclaySheet.Range[startAuditCell, endAuditCell];
                            auditClearRange.ClearComments();
                            //MessageFilter.Register();
                            //startCell = (Microsoft.Office.Interop.Excel.Range)_barclaySheet.Cells[StartRow, 8];
                            //var endCell =
                            //    (Microsoft.Office.Interop.Excel.Range)
                            //        _barclaySheet.Cells[_auditTrialCurrentRow + StartRow - 1, 11];
                            //// total numbers of Last row count
                            //var writeRange = _barclaySheet.Range[startCell, endCell];
                        ...
                        for (var i = 15; i < 15 + _tobTotalCurrentRow; i++)
                        {
                            ...
                            {
                                MessageFilter.Register();
                                var acceptCell = _barclaySheet.get_Range("B" + (i + 2), "F" + (i + 2));
                                ...
                                MessageFilter.Register();
                                var proposed = _barclaySheet.get_Range("B" + (i + 1), "F" + (i + 1));
        ...
        private void btnAuditTrial_Click(CommandBarButton ctrl, ref bool cancelDefault)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "btnAuditTrial_Click();", ex.Message, ex);
            }
        }
        ...
        private void btnProposedLimit_Click(CommandBarButton ctrl, ref bool cancelDefault)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "SetImage();", ex.Message, ex);
            }
        }
        ...
        private void SetVersionInformation()
        {
            ...
            {
                MessageFilter.Register();
                var newRngVersion = _barclaySheet.get_Range("B4", "C4");
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "SetVersionInformation();", ex.Message, ex);
            }
        }
        ...
        public void BindEvent()
        {
            try
            {
                ...
                {
                    MessageFilter.Register();
                    _barclaySheet = Globals.Factory.GetVstoObject(Globals.ThisAddIn.Application.Worksheets.Add());
                    _barclaySheet.Name = Instance.SheetName;
                    _barclaySheet.CustomProperties.Add(_barclaySheet.Name, "True");

                    Microsoft.Office.Interop.Excel.Range objrange = _barclaySheet.Cells[1, 1];
                ...
                else
                {
                    ...
                    _barclaySheet.get_Range(_barclaySheet.Cells[7, StartRowIndexofDepthbook + 0],
                        _barclaySheet.Cells[550, StartRowIndexofDepthbook + 8]).Clear();
                    MessageFilter.Revoke();
                }
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "BindEvent();", ex.Message, ex);
            }
        }
        ...
        public void ConnectCalc()
        {
            try
            {
                ...
                _barclaySheet.Range[_barclaySheet.Cells[StartRow, 13], _barclaySheet.Cells[500, 23]].Clear();
                _dirCadRowCountRepo.Clear();

                _barclaySheet.Range[
                    _barclaySheet.Cells[StartRow, StartRowIndexofCusip + 2],
                    _barclaySheet.Cells[550, StartRowIndexofCusip + 9]].HorizontalAlignment = XlHAlign.xlHAlignRight;
                _barclaySheet.Range[
                    _barclaySheet.Cells[StartRow, StartRowIndexofDepthbook + 2],
                    _barclaySheet.Cells[550, StartRowIndexofDepthbook + 9]].HorizontalAlignment = XlHAlign.xlHAlignRight;
            }
            catch (Exception ex)
            {
                _utils.ErrorLog("BarclayUtility.cs", "ConnectCalc();", "Custom Connection method", ex);
            }
        }
        ...
        public void DisconnectCalc()
        {
            try
            {
                _utils.LogInfo("BarclayUtility.cs", "DisconnectCalc();",
        ...
        public void DeleteContextMenu()
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "DeleteContextMenu();", "delete all the custom right click menus",
                    ex);
            }
        }
        ...
        private void RefreshButtionEnable(bool enable, string imageName)
        {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "RefreshButtionEnable();", ex.Message, ex);
            }
        }
        ...
        public void DeleteStatusImage(string imageName)
        {
            try
            {
                foreach (Microsoft.Office.Interop.Excel.Shape sh in _barclaySheet.Shapes)
                {
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "DeleteStatusImage();", ex.Message, ex);
            }
        }
        ...
        private void SetCommentsInCell(string comments)
        {
            try
            {
                ...
                if (!connectionStatus)
                {
                    Microsoft.Office.Interop.Excel.Range cellCommentRange = _barclaySheet.get_Range("A" + _cellIndex.ToString());
                ...
                {
                     _barclaySheet.get_Range(cellRange).ClearComments();
                }
            }
            catch (Exception ex)
            {
                _utils.ErrorLog("BarclayUtility.cs", "SetCommentsInCell();", ex.Message, ex);
            }
        }
            ...
            bool connectionStatus)
        {
            try
            {
                ...
                {
                    setCellColor = _barclaySheet.get_Range("F11");
        ...
        //when Calc Image delete from Beast side and Image connection status connected or disconnected
        {
            try
            {
                ...
                _utils.LogInfo("BarclayUtility.cs", "GridStatus();", "Updating Image Status: " + calcName + " - " + status);
                if (status == false)
                {
                ...
                if (iteration > 0)
                {
                    _utils.LogInfo("BarclayUtility.cs", "GridStatus();",
            ...
            {
                _utils.ErrorLog("BarclayUtility.cs", "GridStatus();", "CalcName :" + calcName + ", Status: " + status, ex);
            }
        }
