...
namespace WebTradeDirectAddin
{
    ...
    {
        void Load(bool IsSingalRConnected, string UserID, string selectedID);
    ...
    {
        public void Load(bool IsSingalRConnected, string UserID, string SelectedID="")
        {
            TWDUtility.Instance.UserID = UserID;
            TWDUtility.Instance.IsConnected = IsSingalRConnected;
            TWDUtility.Instance.SheetName = SelectedID;
        ...
        {
            return WebTradeDirectAddin.Properties.Resources.EXCEL_TWD_CURRENTVERSION + "^" + WebTradeDirectAddin.Properties.Resources.EXCEL_TWD_OBJGUID + "^Beast_TradeWeb^TradeWeb";
        }
        ...
        {
            string strData = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\TheBeast\\BeastTradeWeb\\Images\\TWD.png" + "^" + WebTradeDirectAddin.Properties.Resources.EXCEL_TWD_CURRENTVERSION + "^" + "TradeWeb" + "^" + "6";
            if (File.Exists(TWDUtility.Instance.BeastExcelDecPath + "\\WhiteLabel.config"))
                strData = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\TheBeast\\BeastExcel\\Images\\BeastIcon.png" + "^" + WebTradeDirectAddin.Properties.Resources.EXCEL_TWD_CURRENTVERSION + "^" + "ECN2" + "^" + "6";
            return strData;
        }
