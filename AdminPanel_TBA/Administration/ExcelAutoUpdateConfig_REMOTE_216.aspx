  ...
  * ======================================================================== */
    ...
    <script type="text/javascript">
        ...
        function YourChangeFun(ddl) {
            //alert(ddl.value);
            document.getElementById('<%= txtProductGuid.ClientID %>').value = ddl.value;
        }
    </script>
                    ...
                    <tr>
                        <td>
                            ...
                            <ul class="nav nav-tabs" id="excelTab" data-tabs="excelTab">
                               ...
                               <%-- <li id="liexcel"><a href="#excel" data-toggle="tab">Click once Files</a></li>--%>
                            </ul>
                                    ...
                                    <div style="width: 90%; margin: 0 auto 20px;" class="allGrid">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td width="20%">
                                                    <asp:DropDownList ID="ddlProduct" runat="server" onchange="YourChangeFun(this);">
                                                    </asp:DropDownList>
                                                </td>
                                                <td width="15%" align="left">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                               <td width="20%">
                                                    <asp:Label ID="lblProductName" runat="server" Text="Installed Product Name"></asp:Label>
                                                </td>
                                                <td width="20%"> 
    ...
    <script type="text/javascript">
        ...
        function validateClickOnceFileData() {
            ...
            if (txtProductVersionValue == "" || txtProductVersionValue == "undefined") {
            ...
            if (!txtProductVersionValue.match(/[0-9]/g) || txtProductVersionValue.length!=8) {
