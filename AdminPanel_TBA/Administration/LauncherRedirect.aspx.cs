...
{
    public partial class LauncherRedirect : System.Web.UI.Page
    {
        string currentPage = "LauncherRedirect";
        ...
        private void ValidateRequest()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (dst.Tables.Count > 0 && dst.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (MsgID != 0 && MsgID != -2)
                        {
                            if (MsgID == -2)
                            {
                                ...
                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User named " + username + ", was not able to download  Beast Launcher for the Auto URL mentioned below (Link is expired) :&nbsp;" +
                                ...
                                if (Convert.ToInt64(sEnableEmail) == 1)
                                {
                                    ...
                                    SendMail(FromEmail, mailto, "Beast Launcher - AutoURL", MsgBody, false);
                                    MsgBody = "";
                                }
                            }
                            else if (MsgID == -5)
                            {
                                ...
                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User named " + username + ", was not able to download  Beast Launcher because of Unauthorized IP Address :&nbsp;" +
                                                           " <table cellpadding='2'><tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">Auto URL:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;<a href =" + AutoURL + ">" + AutoURL + "</a></td></tr> " +
                                                           "<tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">User:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;" + username + "</td></tr> " +
                            ...
                            {
                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User Failed to download Launcher with the AutoURL mentioned below ( Link is invalid ) :&nbsp;" +
                            ...
                            else if (MsgID == -1)
                            {
                                ...
                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User Failed to download Launcher with the AutoURL mentioned below ( User is either not registered or blocked ) :&nbsp;" +
                                                                      " <table cellpadding='2'><tr><td width=\"20% \" style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">Auto URL:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;<a href =" + AutoURL + ">" + AutoURL + "</a></td></tr>" +
                                                                      "<tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">IP Address:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;" + sIpAddress + "</td></tr>" +
                                                                      "<tr><td>Host Name :&nbsp;</td><td>" + Org + "</td></tr>" +
                                                          "<tr><td>City :&nbsp;</td><td>" + City + "</td></tr>" +
                        ...
                        else if (MsgID == -2)
                        {
                            ...
                            if (data == "0")
                            {
                                ...
                                LogUtility.Info("LauncherRedirect.aspx", "ValidateRequest", "Failed to login with the AutoURL as URL Expired, MsgID=-9");
                                Response.Write("<script>alert('Url you clicked was expired but extended automatically for 1 hour.')</script>");

                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User named " + username + ", has successfully download  The Beast Launcher :&nbsp;<br/>" +
                                                  "<table cellpadding='2'>" +
                                                  ...
                                                  "</table>" +
                                                  "<br/><br/>" + UtilityHandler.strVCM_RrMailAddress_Html + "</div>";
                                lnkDownload.Text = "Click here to download TheBeast Launcher";
                            }
                            else
                            {
                                MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User named " + username + ", was not able to download The Beast Launcher  for the Auto URL mentioned below (Link is expired) :&nbsp;" +
                                                     " <table cellpadding='2'><tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">Auto URL:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;<a href =" + AutoURL + ">" + AutoURL + "</a></td></tr> " +
                                                     "<tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">User:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;" + username + "</td></tr> " +
                    ...
                    {
                        MsgBody = "<div style=\"font-size:8pt;font-family:Verdana\">Dear Admin,<br/><br/> User Failed to download  Beast Launcher with the AutoURL mentioned below ( Link is invalid ) :&nbsp;" +
                               " <table cellpadding='2'><tr><td width=\"20% \" style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">Auto URL:</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;<a href =" + AutoURL + ">" + AutoURL + "</a></td></tr>" +
                                 "<tr><td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">IP Address :</td> <td style=\"FONT-SIZE: 8pt; FONT-FAMILY: Verdana;\">&nbsp;" + sIpAddress + "</td></tr>" +
                                  "<tr><td>Host Name :&nbsp;</td><td>" + Org + "</td></tr>" +
                                  "<tr><td>City :&nbsp;</td><td>" + City + "</td></tr>" +
                        ...
                        if (Convert.ToInt64(sEnableEmail) == 1)
                        {
                            SendMail(FromEmail, mailto, "Download The Beast Launcher - AutoURL", MsgBody, false);
                            MsgBody = "";
                        }
                    }
                }
            ...
            {
                //VcmLogManager.Log.writeLog("", Convert.ToString(CurrentSession.User.MOrgDate), Convert.ToString(CurrentSession.User.LocationDesc), currentPage, "ValidateRequest()", ex.StackTrace.ToString() + "<br/><br/>" + ex.Message, UtilityHandler.Get_IPAddress(Request.UserHostAddress));
        ...
        private void SendMail(string strFrom, string strTo, string strSubject, string strBodyMsg, bool bFlag)
        {
            ...
            {
                LogUtility.Error("LauncherRedirect", "SendMail", ex.Message, ex);
            }
        }
        ...
        protected void lnkDownload_Click(object sender, EventArgs e)
        {
            try
            {
                if (lnkDownload.Text == "Click here to download TheBeast Launcher")
                {
                    string path = AppDomain.CurrentDomain.BaseDirectory + "\\WWSApp\\ExeLauncher\\";
            ...
            {
                //VcmLogManager.Log.writeLog(Convert.ToString(CurrentSession.User.FirstName), "", "", "LauncherRedirect", "lnkDownload_Click", ex.StackTrace.ToString() + "<br/><br/>" + ex.Message, VCM_Mail.Get_IPAddress(Request.UserHostAddress));
