<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelAutoURL.aspx.cs" Inherits="Administration.ExcelAutoURL" Async="true" %>
            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">
                                    ...
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                <asp:LinkButton ID="lnkDownload" runat="server" OnClick="lnkDownload_Click" Text="Click here to download Excel Package"></asp:LinkButton>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                        ...
                        <input type="hidden" id="Hidden1" value="true" />
