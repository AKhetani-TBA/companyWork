<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EarningSlabs.aspx.cs" Inherits="HR_EarningSlabs" %>
                                                            ...
                                                            <asp:TemplateField HeaderText="Earnings">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="dgdffdhj0" runat="server" CausesValidation="False" CommandArgument="startRange"
                                                                        CommandName="sort" CssClass="gridlink">Lower</asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Earnings">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="dhfgthf0" runat="server" CausesValidation="False" CommandArgument="endRange"
                                                                        CommandName="sort" CssClass="gridlink">Upper</asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                            ...
                            <fieldset style="padding: 5px; margin-top:5px;">
                                ...
                                <table style="margin: 10px 0px 0px 0px;">
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;<asp:DropDownList ID="earningFor" runat="server" CssClass="ddl">
                                   ...
                                   <%-- <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="style1">
                                            ...
                                            &nbsp;
                                            <span runat="server" id="RsPer">%</span>&nbsp;&nbsp;&nbsp;&nbsp;OR&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:CheckBox ID="checkForOtherAllowence" runat="server" 
                                                Text="Earning for remaining gross" />
                                            </td>
                                    </tr>
