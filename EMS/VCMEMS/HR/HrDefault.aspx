<%@ Page Title="" Language="C#" MasterPageFile="~/HR/Hr.master" AutoEventWireup="true" CodeFile="HrDefault.aspx.cs" Inherits="HR_HrDefault" %>
            ...
            <div style="text-align: left; padding-left: 30px; padding-right: 30px;">
                ...
                *&nbsp; Offering electronic and hybrid brokerage services
                ...
                <div id="adminpopup" runat="server" class="EMS_font" style="padding-bottom: 5px;
                    ...
                    <div id="maxVersion" style="margin-left: 5px; width: 670px;  height:500px;
                        display: none">
