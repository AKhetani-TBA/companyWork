...
//IR_Approved_details table name 
// Att_Save_ApprovedComments sp name
public partial class HR_DailyAttendance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                //DataClasses2DataContext objclass2 = new DataClasses2DataContext();
                //var avc = (from m in objclass2.Table_1s                        
                //          select m).FirstOrDefault();
                // foreach(  
                //Console.WriteLine("elementof", avc);
                //Response.Write(avc);
            }
        }
        catch (Exception ex)
        {
            ErrorHandler.writeLog("DailyAttendance", "Page_Load", ex.Message);
        }
        finally
        {
            es = null;
    ...
    protected void srchView_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            try
            {
                ...
                int ideptId = 0;
                if (showDepartments.SelectedValue.ToString().ToUpper() == "ALL")
                    ideptId = 0;
                else
                    ideptId = Convert.ToInt32(showDepartments.SelectedValue.ToString());
                dsa = objBizAttendance.CheckApprovedData(Convert.ToInt32(((Label)e.Row.Cells[12].FindControl("lblEmpId")).Text), ideptId, Convert.ToDateTime(dateAttendance.Text));
            ...
            {
                ErrorHandler.writeLog("DailyAttendance", "srchView_RowDataBound", ex.Message + " \t\t\n EmpId = " + strName + "\t\t\n Date = " + dateAttendance.Text + "\t\t\n Department = " + showDepartments.SelectedItem.Text);
            }
            finally
            {
    ...
    protected void srchView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendance", "srchView_RowCommand", ex.Message);
        }
    }
    ...
    protected void btnStatusSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (chknight.Checked)
            {
                ...
                objECB.ModifyBy = Session["userName"].ToString();
            ...
            else
            {
                ...
                objECB.FromDate = Convert.ToDateTime(dateAttendance.Text); //Convert.ToDateTime(StartDate.Text);
                objECB.ToDate = Convert.ToDateTime(dateAttendance.Text); // Convert.ToDateTime(EndDate.Text);
                objECB.CreatedBy = winPrincipal.Identity.Name.Substring(winPrincipal.Identity.Name.LastIndexOf(@"\") + 1, winPrincipal.Identity.Name.Length - (winPrincipal.Identity.Name.LastIndexOf(@"\") + 1));
    ...
    protected void statusImageButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendanceReport", "statusImageButton_Click", ex.Message);
        }
    }
    protected void chkSendMail_Click(object sender, ImageClickEventArgs e)// To send mail to employee on leave
    {
        try
        {
            ...
            else if (rbtnHalf.Checked == true)
            {
                ...
                strMailText = "Dear " + (srchView.Rows[Convert.ToInt32(((ImageButton)sender).CommandArgument)].Cells[3]).Text + " ," + "<br/>" +
                              "This is to bring to your kind attention that daily attendance system has alerted you as *ON Half day LEAVE* for the following day :" + "<br/>";
                ...
                subjectline.Value = "HALF DAY LEAVE DETAIL FOR THE DAY";
            }
            else
            {
                //    //empid = ((Label)(srchView.Rows[Convert.ToInt32(((ImageButton)sender).CommandArgument)].Cells[11].FindControl("lblEmpId"))).Text;
            ...
            ds = new DataSet();
            ds = adapt.GetTLDetails(Convert.ToInt32(ViewState["DeptId"].ToString()));
            ...
            string empName = string.Empty; string strcontain = string.Empty; string deptId = string.Empty;
            ...
            //cc = "kpatel@thebeastapps.com";

            cc = System.Configuration.ConfigurationManager.AppSettings["CCAddr"].ToString();
            bcc = ds.Tables[0].Rows[0]["empWorkEmail"].ToString();
            subject = "LEAVE DETAIL FOR THE DAY";
             sendEMail(from, to, cc, " ", subject, strMailText);
            ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Mail To Employee On Leave sent');", true);
        }

        catch (Exception ex)
        {
            ErrorHandler.writeLog("DAilyAttendanceReport", "chkSendMail_Click", ex.Message);
            ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Error in sending Mail To Employee On Leave');", true);
            //throw ex;
        }
    }
    protected void dwnloadLogs_Click(object sender, EventArgs e)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendance", "BtnDownloadLogs_Click", ex.Message);
        }
        finally
        {
            dbObj = null;
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)// To send mail to employee for irregular hours
    {
        //SendMail();
        ...
        try
        {
            ...
            else
            {
                ...
                dsTl = m.CheckTLName(Convert.ToInt32(ViewState["empid"].ToString()));
                if (dsTl.Tables[0].Rows.Count > 0)
                {
                    to = "smittal@thebeastapps.com";
                    strMailText = "";
                    strMailText += "Dear  Sanjay Mittal " + " ," + "<br/>" +
                    "This is to bring to your kind attention that following Team Leader has alerted irregular (detail as per comments) as follows: " + "<br/><br/>";
                ...
                sendEMail(from, to, cc, " ", subject, strMailText);
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Mail for Employee Irregular Attendance sent');", true);
            }
        }
        catch (Exception ex)
        {
            ErrorHandler.writeLog("DailyAttendance", "AutoSendMail()", ex.Message);
            ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Error in sending Mail for Employee Irregular Attendance');", true);
    ...
    protected void btnApproved_Click(object sender, EventArgs e)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendanceReport", "btnApproved_Click", ex.Message);
        }
    }
    ...
    private DataSet SortDetails()
    {
        ...
        try
        {
            ...
            dt = new DataTable();
            int machineCode;
            int userid = Convert.ToInt32(ViewState["uid"]);
            // -1:absent,1:in,2:out,3:all
            machineCode = rbtnAll.Checked ? 3 : rbtnPresent.Checked ? 3 : rbtnAbsent.Checked ? -1 : rbtnIn.Checked ? 1 : 2;
            if (showDepartments.SelectedItem.ToString() == "ALL")
            {
                if (rbtnPresent.Checked == true)
                {
                    ...
                    ds.Tables[0].DefaultView.RowFilter = "Machine_Code <>-1";
            ...
            else
            {
                ...
                if (ViewState["usertype"].ToString() == "0")
                {
                    ...
                    {
                        dt = ds.Tables[0].Clone();
                        ds.Tables[0].DefaultView.RowFilter = "empId=" + userid + "AND Machine_Code <>-1";
                        dt = ds.Tables[0].DefaultView.ToTable();
                        ds.Tables.RemoveAt(0);
                        ds.Tables.Add(dt);
                        return ds;
                    ...
                    {
                        dt = ds.Tables[0].Clone();
                        ds.Tables[0].DefaultView.RowFilter = "empId=" + userid;
                        dt = ds.Tables[0].DefaultView.ToTable();
                        ds.Tables.RemoveAt(0);
                        ds.Tables.Add(dt);
                        return ds;
        ...
        //          
        //         int machineCode;   int userid = Convert.ToInt32(ViewState["uid"]);
        ...
        //         ds = objEmpStatus.GetDailyPresentDetails(DateTime.Parse(dateAttendance.Text).Date, Convert.ToInt32(showDepartments.SelectedValue), machineCode);
        //          dt = ds.Tables[0].DefaultView.ToTable();
        //          dt.DefaultView.RowFilter = "empId=" + userid;
        //          ds.Tables[0].DefaultView.Table = dt ;
        //     }
        ...
        //catch (Exception ex)
        //{
        //    ErrorHandler.writeLog("DailyAttendance", "sortGrid", ex.Message);
        //}
        //finally
        //{
        //    //objEmpStatus = null;
    ...
    protected void fillGridStatus()
    {
        ...
        {
            //-1:absent,1:in,2:out,3:all
            machineCode = rbtnAll.Checked ? 3 : rbtnPresent.Checked ? 3 : rbtnHalf.Checked ? 4 : rbtnAbsent.Checked ? -1 : rbtnIn.Checked ? 1 : 2;
            if (showDepartments.SelectedItem.ToString() == "ALL")
            {
                ...
                {
                    dt = ds.Tables[0].DefaultView.ToTable();
                    dt.DefaultView.RowFilter = "Machine_Code <>-1";
                    srchView.DataSource = dt;
                }
                else if (rbtnHalf.Checked == true)
                {
                    dt = ds.Tables[0].DefaultView.ToTable();
                    dt.DefaultView.RowFilter = "Machine_Code <>-1" + " AND " + "workDayCategory=1";
                    srchView.DataSource = dt;
                    srchView.DataBind();
                }
                else
            ...
            else
            {
                ...
                if (ViewState["usertype"].ToString() == "0")
                {
                    ...
                    {
                        dt = ds.Tables[0].DefaultView.ToTable();
                        dt.DefaultView.RowFilter = "empId=" + userid + "AND " + "Machine_Code <>-1";
                        srchView.DataSource = dt;
                        srchView.DataBind();
                    }
                    else if (rbtnHalf.Checked == true)
                    {
                        dt = ds.Tables[0].DefaultView.ToTable();
                        dt.DefaultView.RowFilter = "empId=" + userid + "AND " + "Machine_Code <>-1" + "AND " + "workDayCategory=1";
                        srchView.DataSource = dt;
                        srchView.DataBind();
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        dt = ds.Tables[0].DefaultView.ToTable();
                        //  dt.DefaultView.RowFilter = "empId=" + userid;
                        // dt1.DefaultView.RowFilter = "Machine_Code <>-1";
                        srchView.DataSource = dt;
                        srchView.DataBind();
                    }
                }
        ...
        {
            ErrorHandler.writeLog("DailyAttendance", "fillGridStatus", ex.Message);
    ...
    protected void setCommentData()
    {
        ...
        catch (Exception ex)
        {
            ...
            ErrorHandler.writeLog("DailyAttendance", "setCommentData()", ex.Message);
        }
        finally
        {
            objBizAttendance_Comments = null;
    ...
    private void getLogDetails(string IPAdd, int machineCode)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendance", "getLogDetails", ex.Message);
        }
    }
    ...
    private void SaveSendIREmail(string EmpId)
    {
        ...
        {
            ErrorHandler.writeLog("DailyAttendance", "SaveSendIREmail()", ex.Message);
        }
    }
    protected void AssignCoff_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objLeaveinfo = new VCM.EMS.Biz.Leave_TakenDetails();
            ds = new DataSet();
            ...
            else
            {
                ...
                for (int i = 0; i < srchView.Rows.Count; i++)
                {
                    ...
                    if (checkBoxSendMail.Checked == true)
                    {
                        ...
                        DateTime dt = Convert.ToDateTime(dateAttendance.Text);
                        string str = dt.ToString("ddd");
                        ds = objLeaveinfo.Check_CoffDetails(0, Convert.ToDateTime(DateTime.ParseExact(dateAttendance.Text, "dd MMMM yyyy", null).ToString("yyyy/MM/dd")));
                        if (ds.Tables[0].Rows[0]["CId"].ToString() == "0" && str != "Sun")
                        {
                            ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Comp Off. cannot be applied ');", true);
                            return;
                        }
                        else
                        {
                            DateTime chkDt = Convert.ToDateTime(dateAttendance.Text);
                            if (chkDt.Date > DateTime.Today)
                            {
                                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Comp Off. cannot be applied  in advance !');", true);
                                return;
                            }
                            else
                            {
                                objLeave.CId = -1;
                                objLeave.CoffDate = Convert.ToDateTime(DateTime.ParseExact(dateAttendance.Text, "dd MMMM yyyy", null).ToString("MM/dd/yyyy"));
                                //Convert.ToDateTime(txtCDate.Text);
                                objLeave.DayType = ((Label)(srchView.Rows[i].Cells[12].FindControl("lblLeaveCategory"))).Text;
                                objLeave.EmpId = Convert.ToInt32(lblempId.Text);
                                objLeave.Comments = null;
                                ...
                                int ret;
                                ret = objLeaveinfo.Save_COffLeaveDetails(objLeave);
                                if (ret == -2)
                                {
                                    ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Comp Off. Leave already applied ');", true);
                                }
                                else
                                {
                                    objLeaveinfo.Save_COffLeaveDetails(objLeave);
                                    ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Message", "alert('Comp Off. applied successfully ! ');", true);
                                }
                            }
                        }
                    }
    ...
    //protected void abMail_Click(object sender, EventArgs e)
    // {
