...
public class Deduction_Slab_Detail
{
	...
	public int SaveDeduction_Slab_Detail(VCM.EMS.Base.Deduction_Slab_Detail objDeduction_Slab_Detail)
	{
		...
		try
		{
			...
			cmd = dbHelper.GetStoredProcCommand("Deduction_Slab_Detail_Save");
    ...
    public int DeleteDeduction_Slab_Detail(System.Int64 slabDetailId)
	{
		...
		{
			dbHelper = DatabaseFactory.CreateDatabase();
            cmd = dbHelper.GetStoredProcCommand("Deduction_Slab_Detail_Delete");
    ...
    public VCM.EMS.Base.Deduction_Slab_Detail GetDeduction_Slab_DetailByID(string order, string fieldName, System.Int64 slabDetailId)
	{
		Database dbHelper = null;
		DbCommand cmd = null;
		try
		{
			dbHelper = DatabaseFactory.CreateDatabase();
			cmd = dbHelper.GetStoredProcCommand("Deduction_Slab_Detail_Select");
			...
			VCM.EMS.Base.Deduction_Slab_Detail objDeduction_Slab_Detail = new VCM.EMS.Base.Deduction_Slab_Detail();
			if (objReader.Read())
			{
	...
	protected VCM.EMS.Base.Deduction_Slab_Detail MapFrom(IDataReader objReader)
	{
		VCM.EMS.Base.Deduction_Slab_Detail objDeduction_Slab_Detail = new VCM.EMS.Base.Deduction_Slab_Detail();
