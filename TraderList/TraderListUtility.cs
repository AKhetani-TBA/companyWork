...
namespace TraderList
{
    ...
    internal class TraderListUtility
    {
        ...
        public TraderListUtility()
        {
            ...
            _beastAddin = TraderList.Globals.ThisAddIn.Application.COMAddIns.Item(ref addinRef);
        ...
        public void SendImageRequest()
        {
            ...
            _utils.StoreBondGridCellName("vcm_calc_TraderList_Excel", TraderList.Globals.ThisAddIn.Application.ActiveWorkbook.Name,
        ...
        private const int sifIdOfBarclayExcel = 3159;
        ...
        private bool CreateNewRangeForSubmitOrder(Microsoft.Office.Interop.Excel.Range target)
        {
            try
            {
                     ...
                     target.Columns.Count == 1))
                {
                    ...
                    {
                        TraderList.Messagecls.AlertMessage(14, "");
                        return true;
                    }
        ...
        private bool LimitValidation(Microsoft.Office.Interop.Excel.Range cellRange)
        {
            ...
            foreach (Microsoft.Office.Interop.Excel.Range excelcell in cellRange)
            {
                if (excelcell.Column == 1)
                {
                    ...
                    string C1 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 2].Value);
                    string C2 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 3].Value);
                    string C3 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 4].Value);
                    string C4 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 5].Value);
                    string C5 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 6].Value);

                    string P1 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 2].Value);
                    string P2 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 3].Value);
                    string P3 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 4].Value);
                    string P4 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 5].Value);
                    string P5 = Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 6].Value);
                    ...
                    {
                        TraderList.Messagecls.AlertMessage(18, "Current Limit");
                    ...
                    {
                        TraderList.Messagecls.AlertMessage(19, "Propose Limit");
                        return false;
                    ...
                    {
                        TraderList.Messagecls.AlertMessage(20, "Current Limit");
                    ...
                    else if (!string.IsNullOrEmpty(P1) || !string.IsNullOrEmpty(P2) || !string.IsNullOrEmpty(P3) || !string.IsNullOrEmpty(P4) || !string.IsNullOrEmpty(P5))
                    {
                        ...
                        {
                            TraderList.Messagecls.AlertMessage(21, "Propose Limit");
                        ...
                        if (numP1 <= 0 || numP2 <= 0)
                        {
                            TraderList.Messagecls.AlertMessage(22, "Propose Limit");
                            return false;
                        }
                    }
                    else
        ...
        public void EnableDisableContextMenu()
        {
            try
            {
                if (TraderList.Globals.ThisAddIn.Application.ActiveWorkbook.Name == Instance.Workbookname &&
                    TraderList.Globals.ThisAddIn.Application.ActiveSheet.Name == Instance.SheetName && IsConnected)
                {
            ...
            try
            {
                if (target.Column == 18 && target.Columns.Count == 1 && target.Value2 != null)
                {
                    ...
                    foreach (Microsoft.Office.Interop.Excel.Range cell in target.Cells)
                    {
                        ...
                        {
                            TraderList.Messagecls.AlertMessage(15, "");
                            return;
                        }
                    }
                    _submitOrderXml = _xdCusip.InnerXml;
        ...
        private void DisplayRefreshButton(int targetColumn)
        {
            try
            {
                var cellRange = (Microsoft.Office.Interop.Excel.Range)TraderList.Globals.ThisAddIn.Application.Selection;

                if (TraderList.Globals.ThisAddIn.Application.ActiveSheet.Name == SheetName)
                {
        ...
        private bool IsExcelInEditMode()
        {
            try
            {
                TraderList.Globals.ThisAddIn.Application.Interactive = TraderList.Globals.ThisAddIn.Application.Interactive;
                return false;
            }
            catch
            {
        ...
        public void k_keyListener_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (Convert.ToString(TraderList.Globals.ThisAddIn.Application.ActiveSheet.Name).ToLower() == TraderListUtility.Instance.SheetName.ToLower())
                {
                    if (e.KeyCode == Keys.Apps)
                    {
                        TraderList.MessageFilter.Register();
                        var selectRangeCnt =
                            (Microsoft.Office.Interop.Excel.Range)TraderList.Globals.ThisAddIn.Application.Selection;
                        if (selectRangeCnt != null)
                            RightClickDisableMenu(selectRangeCnt);
                        TraderList.MessageFilter.Revoke();
                    }
                }
            }
            catch (Exception ex)
                            ...
                            case "712":
                                {
                                    ...
                                    if (comboList.ToString() != "0")
                                    {
                                        ...
                                        Microsoft.Office.Tools.Excel.Worksheet vstoWorksheet = Globals.Factory.GetVstoObject(_tradeListSheet);
        ...
        private void Create_WorkSheet(string cellValue)
        {
            ...
            try
            {
                // *************************************** Call Load in WebTradeDirectAddin *********************************************

                /*Assembly assembly = Assembly.LoadFrom(@"D:\Personal\Private Repository\ExcelAddIn\WebTradeDirectAddin\bin\Release\WebTradeDirectAddin.dll");

                Type type = assembly.GetType("WebTradeDirectAddin.WebTradeDirectAddinUtil");
                 if (type != null)
                 {
                     ...
                     if (methodInfo != null)
                     {
                         ...
                         {
                             object[] parametersArray = new object[] { IsConnected, cellValue };
                ...
                // *************************************** Call LoadCustomAddins in ConnectionManager *********************************************

                Assembly assembly1 = Assembly.LoadFrom(@"D:\Personal\Private Repository\ExcelAddIn\ExcelAddIn5\bin\Debug\TheBeastAppsAddin.dll");

                Type type = assembly1.GetType("ExcelAddIn5.ConnectionManager");
                if (type != null)
                {
                    MethodInfo methodInfo = type.GetMethod("LoadCustomAddIns");
                    if (methodInfo != null)
                    {
                        object result = null;
                        ParameterInfo[] parameters = methodInfo.GetParameters();
                        ...
                        {
                            object[] parametersArray = new object[] { false, true, "WebTradeDirectAddin" };
                ...
                // ************************************** Call Method using Reference of DLL ********************************************

                //WebTradeDirectAddinUtil WTDAddin = new WebTradeDirectAddinUtil();
                //AddinUtilities AddUtil = new AddinUtilities();

                

                //WTDAddin.Load(IsConnected, cellValue);
                //AddUtil.SendImageRequest("vcm_calc_tradeweb_top_of_book", 3150, "WebTradeDirectAddin");

               
               // AddUtil.SendImageRequest(

                
                //Microsoft.Office.Interop.Excel.Workbook xlWorkbook = TraderList.Globals.ThisAddIn.Application.ActiveWorkbook;
               ...
               //                }
                 ...
                 // *************************************** Call image looking registry in Setting *********************************************

                 // Assembly assembly1 = Assembly.LoadFrom(@"D:\Personal\Private Repository\ExcelAddIn\ExcelAddIn5\bin\Debug\TheBeastAppsAddin.dll");

                 //Type type = assembly1.GetType("ExcelAddIn5.Settings");
                 //if (type != null)
                 //{
                 //    MethodInfo methodInfo = type.GetMethod("Item_Get");
                 //    if (methodInfo != null)
                 //    {
                 //        object result = null;
                 //        ParameterInfo[] parameters = methodInfo.GetParameters();
        ...
        public void BindContextMenu()
        {
            try
            {
                ...
                //_cb = TraderList.Globals.ThisAddIn.Application.CommandBars["Cell"];
            ...
            foreach (Microsoft.Office.Interop.Excel.Range excelcell in cellRange)
            {
                ...
                if (_userEmailId.Length < arrIndex || _userEmailId.Length == 0)
                {
                    userNames = userNames == string.Empty
                        ? Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 1].Value)
                        : userNames + "," +
                          Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 1].Value);
                }
        ...
        private void CreateProposedLimitXml(string calcname, Microsoft.Office.Interop.Excel.Range cellRange)
        {
            ...
            foreach (Microsoft.Office.Interop.Excel.Range excelcell in cellRange)
            {
                if (excelcell.Column == 1)
                {
                    ...
                    if (String.IsNullOrEmpty(Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 2].Value)) &&
                        !String.IsNullOrEmpty(Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 5].Value)))
                    {
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C1")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 2].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C2")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 3].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C3")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 4].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C4")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 5].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C5")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo, 6].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P1")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 2].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P2")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 3].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P3")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 4].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P4")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 5].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P5")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[cellrowNo + 1, 6].Value);
                    }
                    else
                    {
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C1")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 2].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C2")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 3].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C3")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 4].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C4")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 5].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("C5")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row, 6].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P1")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row + 1, 2].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P2")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row + 1, 3].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P3")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row + 1, 4].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P4")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row + 1, 5].Value);
                        childnodeCusip.Attributes.Append(_xdCusip.CreateAttribute("P5")).InnerText =
                            Convert.ToString(TraderList.Globals.ThisAddIn.Application.Cells[excelcell.Row + 1, 6].Value);
                    }
        ...
        private void btnProposedLimit_Click(CommandBarButton ctrl, ref bool cancelDefault)
        {
            try
            {
                var selectRangeCnt = (Microsoft.Office.Interop.Excel.Range)TraderList.Globals.ThisAddIn.Application.Selection;
        ...
        public void BindEvent()
        {
            try
            {
                ...
                {
                    TraderList.MessageFilter.Register();
                    _tradeListSheet = TraderList.Globals.Factory.GetVstoObject(TraderList.Globals.ThisAddIn.Application.Worksheets.Add());
                ...
                else
                {
                    TraderList.MessageFilter.Register();
                    _tradeListSheet =
                        TraderList.Globals.Factory.GetVstoObject(TraderList.Globals.ThisAddIn.Application.Worksheets[Instance.SheetName]);
