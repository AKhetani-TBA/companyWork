        ...
        */
        ...
        public void GetOrderedStatusByOrderID(string ActionType, string CalcName)
        {
            try
            {
                ...
                xmlRoot.AppendChild(XDCusip.CreateElement("Version")).InnerText = Convert.ToString(WebTradeDirectAddin.Properties.Resources.EXCEL_TWD_CURRENTVERSION);
                                    ...
                                    if (Convert.ToString(DataArryAcceptReject[rowIndex]) == "1")
                                    {
                                        ...
                                        if (blinkCounter == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                WebTradeDirectAddin.FlashWindow.Flash(handle);
                                            }
                                            catch (Exception ex) { }
                                            blinkCounter++;
                                        }
